...
class TestAdvertRecommendation:
    ...
    # TODO: Должен проходить этот тест, но я не могу понять почему вместо 404 возвращается 200 с пустым телом. А ИКАТЬ В СЕРВИСЕ АНТОНА БАГ .... ЛУЧШЕ СРАЗУ ЗАСТРЕЛИТЬСЯ
